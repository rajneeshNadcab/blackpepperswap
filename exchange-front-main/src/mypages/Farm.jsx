                          ...
                          <div className="accordion-item" style={{ marginBottom: '12px' }}>
                            <h2 className="accordion-header" id={`headingTwo${index}`}>
                              <button
                               ...
                               onClick={()=>{ setIndex(index); setArrow(ind==index && (arrowToggle?false:true)); }}
                              >
                                <div className="row justify-content-center">
                                  ...
                                  <div className="col-md-1 col-12 col-12 d-flex justify-content-end up-down">{arrowToggle && ind==index?<MdArrowDropUp style={{fontSize:"30px", color:" rgb(171, 196, 255)"}}/>:<MdArrowDropDown style={{fontSize:"30px", color:" rgb(171, 196, 255)"}}/>}</div>
                                </div>
                              </button>
                            </h2>
                            <div
                        ...
                        <div className="accordion-item" style={{ marginBottom: '12px' }}>
                          <h2 className="accordion-header" id={`headingTwo${index}`}>
                            <button
                              ...
                              aria-expanded="true"
                              aria-controls={`collapseTwo${index}`}
                              onClick={()=>{setIndex(index);setArrow(!arrowToggle); }}
                            >
                              <div className="row justify-content-center">
                                ...
                                <div className="coll col-md-1 col-0 up-down">{arrowToggle && ind==index?<MdArrowDropUp style={{fontSize:"30px"}}/>:<MdArrowDropDown style={{fontSize:"30px"}}/>}</div>
                              </div>
                            </button>
                          </h2>
                          <div
                            ...
                            <div className="accordion-item" style={{ marginBottom: '12px' }}>
                              <h2 className="accordion-header" id={`headingTwo${index}`}>
                                <button
                                  ...
                                  aria-expanded="false"
                                  aria-controls={`collapseTwo${index}`}
                                 onClick={()=>{setArrow(!arrowToggle); setIndex(index)}}
                                >
                                  <div className="row justify-content-center">
                                    ...
                                    <div className="coll col-md-1 up-down">{arrowToggle && ind==index?<MdArrowDropUp style={{fontSize:"30px"}}/>:<MdArrowDropDown style={{fontSize:"30px"}}/>}</div>
                                  </div>
                                </button>
                              </h2>
                              <div
