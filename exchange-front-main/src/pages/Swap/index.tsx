...
export default function Swap() {
  ...
  const [loader, setLoader] = useState(true)
   const [Input,setInputCurrency] =useState(null)
   const [Output,setOutputCurrency] =useState(null)
  ...
  const handleInputSelect = useCallback(
    inputCurrency => {
      ...
      if (inputCurrency.symbol.toLowerCase() === 'syrup') {
       ...
       setInputCurrency(inputCurrency.symbol.toLowerCase())
    },
  ...
  const handleOutputSelect = useCallback(
    outputCurrency => {
      ...
      if (outputCurrency.symbol.toLowerCase() === 'syrup') {
       ...
       setOutputCurrency(outputCurrency.symbol.toLowerCase())
          ...
          <div className=" tradeC col-lg-8 col-md-6 col-12 order-1 py-2">
            ...
            {!loader && (
              <div className="tradeViewChart" style={{ background: 'transparent', height: '100%', width: '100%' }}>
                <CandleGraph iCurrency={Input} oCurrency={Output} />
              </div>
            )}
          </div>
            ...
            <AppBody>
              ...
              <Wrapper id="swap-page">
                ...
                <AutoColumn gap={'md'}>
                  <CurrencyInputPanel
                    label={
                      independentField === Field.OUTPUT && !showWrap && trade ? 'From (estimated)' : i18n(308, 'From')
                    }
