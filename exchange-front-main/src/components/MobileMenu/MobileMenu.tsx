      ...
      <StyledMobileMenuWrapper>
        ...
        <StyledMobileMenu>
          ...
          <Cn>
            ...
            <StyledAbsoluteLink  href="/exchange#/farm" onClick={()=>{setTimeout(()=>window.location.reload(),100)}} id='sidepane'>
          ...
          <Cn>
            ...
            <StyledAbsoluteLink  href="/exchange#/staking" onClick={()=>{setTimeout(()=>window.location.reload(),100)}} id='sidepane'>
          ...
          <Cn>
            ...
            <StyledAbsoluteLink  href="/exchange#/lockvault" onClick={()=>{setTimeout(()=>window.location.reload(),100)}} id='sidepane'>
          ...
          <Cn>
            <StyledLink to="/"  className='sidepane' onClick={()=>{setTimeout(()=>window.location.reload(),100)}}>   {/* className="active" */}
              <TranslatedText translationId={202}>Exchange</TranslatedText>
            </StyledLink>
          </Cn>
          <Cn>
           
            <StyledAbsoluteLink  href="/exchange#/ido" id='sidepane' onClick={()=>{setTimeout(()=>window.location.reload(),100)}}>IDO</StyledAbsoluteLink>
